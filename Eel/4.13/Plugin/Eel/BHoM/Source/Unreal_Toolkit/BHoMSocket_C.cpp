...
#include "BHoMSocket_C.h"


// Sets default values
ABHoMSocket_C::ABHoMSocket_C()
{
...
void ABHoMSocket_C::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
SOCKET ABHoMSocket_C::CreateSocket(int port)
{
	//Initialise winsock
	WSADATA wsa;
...
void ABHoMSocket_C::RunSocket(ABHoMSocket_C* socket)
{
	while (1)
	{
...
bool ABHoMSocket_C::GetInt(SOCKET &s, int& value)
{
	int32_t buff;
...
bool ABHoMSocket_C::GetString(SOCKET &s, std::string & _string)
{
...
bool ABHoMSocket_C::GetAll(SOCKET &s, char* data, int totalbytes)
{
