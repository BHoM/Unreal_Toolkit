...
using BH.Adapter;
using BH.Engine.Unreal_oM;

namespace BH.Adapter.Unreal_oM
{
    public partial class Unreal_oMAdapter : BHoMAdapter
    {
        ...
        public Unreal_oMAdapter()
        {
            AdapterId = BH.Engine.Unreal_oM.Convert.AdapterId;   //Set the "AdapterId" to "SoftwareName_id". Generally stored as a constant string in the convert class in the SoftwareName_Engine
